...
import 'package:meytrash_mobile/pages/donasi/donasi_controller.dart';
import 'package:meytrash_mobile/theme.dart';

class DonasiPage extends StatelessWidget {
  DonasiPage({super.key});
            ...
            GestureDetector(
              onTap: () {
                ...
                _tampilImagePickerOptions(
                    context, imagePicker, donasiController);
              },
              child: Container(
                  height: 200,
                  width: 220,
                  ...
                  child: Obx(() {
                    return ClipRRect(
                      ...
                      child: donasiController.selectedImage.value != null
                          ? Image.file(
                              donasiController.selectedImage.value!,
                              height: 200,
                              width: 220,
                              fit: BoxFit.cover,
                            )
...
void _tampilImagePickerOptions(BuildContext context, ImagePicker imagePicker,
    DonasiController signUpController) {
